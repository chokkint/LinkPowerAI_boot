...
public class ReflectUtils {
	 ...
	 * 
	 * @param object
	 * @param superClasslimit
	 * @return
	 */
	public static List<Field> getFields(Object object, final Class<?> superClasslimit) {
		Assert.notNull(object, "object不能为空");
		Assert.notNull(superClasslimit, "superClasslimit不能为空");
		Class<?> objectClass = object.getClass();
		List<Field> fields = new ArrayList<Field>();
		for (Class<?> superClass = objectClass; superClass != superClasslimit; superClass = superClass.getSuperclass()) {
