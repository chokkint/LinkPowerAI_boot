...
import com.ai.ringball.dao.biz.ShellParam;
...
public class RmtShellExecutor {
	 ...
	 * RmtShellExecutor exe = new RmtShellExecutor("***.**.**.***", "sshapp",
	 * "sshapp"); // 执行myTest.sh 参数为java Know dummy System.out.println(exe.exec(
