...
ace.settings = {
	...
	navbar_fixed : function(a, d, b) {
		...
		if (!a && b !== false) {
			var e = null;
			if (ace.settings.is("sidebar", "fixed")
					|| ((e = document.getElementById("sidebar")) && ace.hasClass(e, "sidebar-fixed"))) {
	...
	sidebar_fixed : function(a, d, c) {
		...
		if (!a && c !== false) {
			var b = null;
			if (ace.settings.is("breadcrumbs", "fixed")
					|| ((b = document.getElementById("breadcrumbs")) && ace.hasClass(b, "breadcrumbs-fixed"))) {
